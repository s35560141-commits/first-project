  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        sad: {
          primary: "hsl(var(--sad-primary))",
          secondary: "hsl(var(--sad-secondary))",
        },
        relaxed: {
          primary: "hsl(var(--relaxed-primary))",
          secondary: "hsl(var(--relaxed-secondary))",
        },
        energetic: {
        ...
        focused: {
          primary: "hsl(var(--focused-primary))",
          secondary: "hsl(var(--focused-secondary))",
        },
      },
      backgroundImage: {
